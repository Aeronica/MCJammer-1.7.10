package net.aeronica.mods.mcjammer.client.mml.util;
    ...
    public class StatePart {
        ...
        public String toString() {
            return new String ("@PartState: oct="+octave+", vol="+volume+
                    ", mmlLength="+mmlLength+" ,runningTicks="+runningTicks+
                    ", tied="+tied); 
        }
        ...
        public void setVolume(int volume) {
            this.volume = getMinMax(0, 15, volume);
        }
        ...
        public void accumulateTicks(long n) {
            this.runningTicks = this.runningTicks + n;
        }
        ...
        private int getMinMax(int min, int max, int value) {
